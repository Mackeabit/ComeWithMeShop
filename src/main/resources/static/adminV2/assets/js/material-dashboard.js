...
function initNavs() {
    total.forEach(function(l, e) {
        var s = document.createElement("div")
            , a = l.querySelector(".nav-link.active").cloneNode();
        a.innerHTML = "-",
        ...
        if (n) {
            ...
            if (l.classList.contains("flex-column")) {
                for (var i = 1; i <= e.indexOf(n); i++)
                    t += l.querySelector("li:nth-child(" + i + ")").offsetHeight;
                s.style.transform = "translate3d(0px," + t + "px, 0px)",
                    s.style.width = l.querySelector("li:nth-child(" + a + ")").offsetWidth + "px",
                    s.style.height = l.querySelector("li:nth-child(" + i + ")").offsetHeight
            } else {
                for (i = 1; i <= e.indexOf(n); i++)
                    t += l.querySelector("li:nth-child(" + i + ")").offsetWidth;
                s.style.transform = "translate3d(" + t + "px, 0px, 0px)",
                    s.style.width = l.querySelector("li:nth-child(" + a + ")").offsetWidth + "px"
            }
        }
...
function showError(e, t) {
    const a = e.parentElement
        , n = (a.className = "input-group input-group-outline my-5 is-invalid is-filled",
        a.querySelector("small"));
    n.innerText = t
}
function showSucces(e) {
    const t = e.parentElement;
    t.className = "input-group input-group-outline my-5 is-valid is-filled"
}
